...
class _ForgotPassEmailState extends State<ForgotPassEmail> {
  ...
  Future checkUser()async{
    ...
    if(res=="Invalidemail"){
      Fluttertoast.showToast(msg: "Ce e-mail est incorrect".tr,toastLength: Toast.LENGTH_SHORT, fontSize: 12, gravity: ToastGravity.BOTTOM, backgroundColor: Colors.deepPurple, textColor: Colors.white);
    }else{
      //generate code :
      print(codeReset);
      ...
      Fluttertoast.showToast(msg: "Vérifiez votre boîte de réception".tr,toastLength: Toast.LENGTH_SHORT, fontSize: 12, gravity: ToastGravity.BOTTOM, backgroundColor: Colors.black, textColor: Colors.white);
